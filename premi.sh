...
TIMES="10"
CHATID="7661292905"
KEY="7571142007:AAGC7Gs0M6OXgrZivkKsyCc9M8Uv55Acfnc"
...
💥 » <code>Aktif  :</code><code>30 Hari</code>
<code>────────────────────</code>
<b> SCRIPT NOTIF </b>
<code>────────────────────</code>
...
wget https://raw.githubusercontent.com/Mrz051/vip2/master/limit/limit.sh && chmod +x limit.sh && ./limit.sh
cd
